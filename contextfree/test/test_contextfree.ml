...
(*#### Exercise 3 *)
let%test "balanced_parentheses_1" = derive balanced_parentheses [3; 4; 5; 12] |> to_string = "()[]{}"
let%test "balanced_parentheses_2" = derive balanced_parentheses [10; 0; 8] |> to_string = "({})[]"
let%test "balanced_parentheses_3" = derive balanced_parentheses [0; 2; 4; 1; 5; 6] |> to_string = "({[][{}()]})"

 (*#### Exercise 5 *)
let%test "zero_one_same_1" = derive same_amount [8] |> to_string = ""
let%test "zero_one_same_2" = derive same_amount [0; 8] |> to_string = "1001"
let%test "zero_one_same_3" = derive same_amount [4; 1; 7 ] |> to_string = "00110101"
let%test "zero_one_same_4" = derive same_amount [5; 4; 3; 8] |> to_string = "10001110"
